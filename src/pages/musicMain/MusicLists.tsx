    ...
    return (
      <>
        <div
          ...
          className="scroll-container h-36 w-40 origin-top-left overflow-y-auto overflow-x-hidden rounded-lg border-4 border-solid border-black transition-all duration-[270ms]"
        >
          {arrs.map((_, index) => (
